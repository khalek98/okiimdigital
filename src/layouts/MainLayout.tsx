  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" type="image/ico" sizes="16x16" href="favicons/favicon.ico" />
      ...
      {formStatus === "success" && (
        <Notification status={formStatus} message="Message sent successfully!" />
      )}
      {formStatus === "error" && (
        <Notification status={formStatus} message="Somethig went wrong... Try again!" />
      )}

      {!cookiesAccept && showCookieBar && <CookieBar setCookies={closeCookiePopup} />}
