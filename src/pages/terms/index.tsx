  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content={`Terms and Conditions for ${info.fullname}`}
        />
        <title>Terms and Conditions | Okiimdigital Ltd</title>
      </Head>
          ...
          <div className="container">
            ...
            <div className={styles.textWrapper}>
              ...
              <p>
                ...
                conditions. Do not continue to use {info.fullname} if you do not
              ...
              <p>
                We employ the use of cookies. By accessing {info.fullname}, you
                agreed to use cookies in agreement with the {info.fullname}'s
                Privacy Policy.
              </p>
              ...
              <p>
                Unless otherwise stated, {info.fullname} and/or its licensors
                own the intellectual property rights for all material on{" "}
                {info.fullname}. All intellectual property rights are reserved.
                You may access this from {info.fullname} for your own personal
                use subjected to restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from {info.fullname}</li>
                <li>Sell, rent or sub-license material from {info.fullname}</li>
                <li>
                  Reproduce, duplicate or copy material from {info.fullname}
                </li>
                <li>Redistribute content from {info.fullname}</li>
              </ul>
              ...
              <p>
                {info.fullname} reserves the right to monitor all Comments and
              ...
              <p>
                You hereby grant {info.fullname} a non-exclusive license to use,
              ...
              <p>
                ...
                of {info.fullname}; and (d) the link is in the context of
              ...
              <p>
                ...
                by sending an e-mail to {info.fullname}. Please include your
              ...
              <p>
                No use of {info.fullname}'s logo or other artwork will be
