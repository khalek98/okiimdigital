  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content={`Privacy Policy for ${info.fullname}`}
        />
        <title>Privacy Policy | Okiimdigital Ltd</title>
      </Head>
          ...
          <div className="container">
            ...
            <div className={styles.textWrapper}>
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to {info.fullname},
                    accessible from{" "}
                    <a
                      href={`https://${info.url}/`}
              ...
              <ul>
                <li>By email: info@okiimdigital.com</li>
              </ul>
            </div>
          </div>
        </section>
